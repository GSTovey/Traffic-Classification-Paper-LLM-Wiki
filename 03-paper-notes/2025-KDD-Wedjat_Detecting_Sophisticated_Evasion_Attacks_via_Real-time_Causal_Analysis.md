...
- vs [[2025-USENIX-CertTA__Certified_Robustness_Made_Practical_for_Learning-Based_Traffic_Analysis]]：CertTA 提供认证鲁棒性，但依赖特定的扰动模型；Wedjat 通过因果关系提供结构性鲁棒性
- vs [[2026-NDSS-A_Hard-Label_Black-Box_Evasion_Attack_against_ML-based_Malicious_Traffic_Detection_Systems]]：该工作展示黑盒逃逸攻击的有效性；Wedjat 的因果方法可能对此类攻击更鲁棒
...
- [[2025-USENIX-CertTA__Certified_Robustness_Made_Practical_for_Learning-Based_Traffic_Analysis]]：同为提升鲁棒性的工作，CertTA 提供认证鲁棒性，Wedjat 提供因果鲁棒性
- [[2026-NDSS-A_Hard-Label_Black-Box_Evasion_Attack_against_ML-based_Malicious_Traffic_Detection_Systems]]：展示黑盒逃逸攻击的有效性，Wedjat 的因果方法可能对此类攻击更鲁棒
