...
- ET-BERT：BPE tokenization + BERT 预训练的加密流量表示 — `[[03-paper-notes/2022-WWW-ET-BERT__A_Contextualized_Datagram_Representation_with_Pre-training_Transformers_for_Encrypted_Traffic_Classification.md]]`
- YaTC：MFR 矩阵 + 分层注意力的多层级流量表示 — `[[03-paper-notes/2023-AAAI-Yet_Another_Traffic_Classifier_a_Masked_Autoencoder_Based_Traffic_Transformer_With_Multi-level_Flow_Representation.md]]`
- Sweet Danger：揭示流量表示中的 per-packet split 数据泄露和 shortcut learning 问题 — `[[03-paper-notes/2025-SIGCOMM-The_Sweet_Danger_of_Sugar_Debunking_Representation_Learning_for_Encrypted_Traffic_Classification.md]]`
- GraphDApp：TIG 图结构表示，从四个维度保留流量特征 — `[[03-paper-notes/2021-TIFS-Accurate_Decentralized_Application_Identification_via_Encrypted_Traffic_Analysis_Using_Graph_Neural_Networks.md]]`
- MM4flow：多模态表示（payload byte stream + packet length sequence），byte-level 优于 2-gram — `[[03-paper-notes/2025-CCS-MM4flow__A_Pre-trained_Multi-modal_Model_for_Versatile_Network_Traffic_Analysis.md]]`
- Talk Like a Packet：系统分类流量基础模型的输入表示方案 — `[[03-paper-notes/2026-arXiv-Talk_Like_a_Packet__Rethinking_Network_Traffic_Analysis_with_Transformer_Foundation_Models.md]]`
- FlowPic：2D 直方图图像化表示，将流的包大小和到达时间转化为二维图像 — `[[03-paper-notes/2019-INFOCOM-FlowPic__Encrypted_Internet_Traffic_Classification_is_as_Easy_as_Image_Recognition.md]]`
- MIETT：多实例 packet 级表示，Two-Level Attention 分层建模 token/packet 关系 — `[[03-paper-notes/2025-AAAI-MIETT__Multi-Instance_Encrypted_Traffic_Transformer_for_Encrypted_Traffic_Classification.md]]`
- TraGe：Header-Payload 差异化表示，Field-level Masking + Dynamic Masking — `[[03-paper-notes/2025-IWQoS-TraGe_A_Generic_Packet_Representation_for_Traffic_Classification_Based_on_Header-Payload_Differences.md]]`
- ASNet：词义聚合表示，WSA 无参数聚合恢复被 WordPiece 拆分的完整词义 — `[[03-paper-notes/2025-TIFS-Bottom_Aggregating_Top_Separating_An_Aggregator_and_Separator_Network_for_Encrypted_Traffic_Understanding.md]]`
