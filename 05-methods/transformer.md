...
| Talk Like a Packet (arXiv 2026) | 2026 | 综述性研究，系统分类流量基础模型的架构、输入模态和预训练策略 | 提出统一的 Transformer 流量基础模型预训练与微调流水线，从架构（BERT/ViT/T5/GPT/混合）、输入模态和预训练策略三个维度建立系统分类体系，验证基础模型在分类、预测和生成三大任务上的泛化能力 |
