...
![](images/7f1c90ca033af7d76ab46bd9cb7c65e8af655ea4977108601acb508846929352.jpg)
...
![](images/449ec17e6fd7cd8019054b7553b9c2d794c59855c05cc317a5180b2fdb44bc52.jpg)
...
![](images/79be45d40ba2ddc8390f07b9e48c2836eabe759dd800f3abcfbdfe883bd8ba79.jpg)
...
Given an input $X \in \mathbb { R } ^ { n \times d _ { \mathrm { m o d e l } } }$ , where n is the sequence length and $d _ { \mathrm { m o d e l } }$ is the model dimension, the computation of transformer’s attention layer [21] could be divided into four stages.
...
Table 2: Performance of different methods with varying learning rates, batch sizes and model configurations. ‘SDPA’ refers to the sigmoid gating after SDPA in Eq 3, and ‘sandwitch norm’ [43] indicates normalizing attention/ffn outputs before adding them to the residual. When using gating, we reduce FFN’s width so that all methods have the same number of parameters. ‘-’ means the model diverges during training. 
...
Inspired by prior works that utilize group norm for the SDPA output [13, 44], with the same setting in Sec. 3.2.1, we apply RMSNorm [25] independently to the
...
Given that adding non-linearity between two linear mappings can improve their expensiveness [45], we have two modifications to mitigate the low-rank problem:
...
![](images/dfd894d835d9dd7e26c96b0b2ec6e09574d6327532f086b38fcbc57fa6c85e4a.jpg)
...
![](images/d2b783a81d79528c63d45175362fcb5cd4475ef49209d7975814d776affe93cb.jpg)

<details>
<summary>histogram</summary>

| Gate Score Range | Normalized Density |
| ---------------- | ------------------ |
| 0.0 - 0.1        | 0.09               |
| 0.1 - 0.2        | 0.03               |
| 0.2 - 0.3        | 0.01               |
...
![](images/52d380e4c87823deb9be34acb2c700b31583be87bb1aa5fa5532280ae1133a99.jpg)
...
$$
\mathrm{NS-sigmoid} (x) = 0. 5 + 0. 5 \cdot \mathrm{sigmoid} (x), \tag {9}
$$
...
[62] Piotr Pi˛ekos, Róbert Csordás, and Jürgen Schmidhuber. Mixture of sparse attention: Contentbased learnable sparse attention via expert-choice routing, 2025.   
...
![](images/2aeb35c137305452fe8ddc8f5a657708f9403877ecdfb67fd5d6ba9cf24e60a1.jpg)
...
![](images/44ecfbdb46332ac9b0631629ee1243d9ed71951f4d386879dc9c4b603ff8a69c.jpg)
...
![](images/95a0c76f3ac08598baf1878628f28c746ae7636ec7e999e410f094cc6ec6a1f7.jpg)
...
![](images/25a317f1ecf408e2c3ceff3b037487e5e813b9f533c49fe3f9d4fae9370b1765.jpg)
...
![](images/378658d669b0916461a3c4eeb9d3ec6849eaee273950551b6cda516dcd706e46.jpg)
...
![](images/f4e1168b716471f2df5ac6c0f114bd59de4c1d716c0673ea602bb6f0808fccd0.jpg)
...
![](images/73609b313def8f97c4d69ed91cbc0a3159be0a266120107ce42639baff8275b5.jpg)
...
![](images/bc8cc69b46bb3740b606a29386686d7cf4e76653f12776dbe3adc8a38e57deeb.jpg)
...
![](images/a8fbd0961c18d9486cef22e6e1c9bcb6941520f86817077c6d252289ffc04240.jpg)
...
![](images/bd88742686274b1a721e439e5450ff06370833f61113fddd9800328f4dd74941.jpg)

<details>
<summary>line</summary>

| Layer | attn_output | ffn_output | attn_residual | fnn_residual |
|-------|-------------|------------|---------------|--------------|
| 0     | 0           | 0          | 0             | 0            |
| 5     | 0           | 250        | 400           | 400          |
| 10    | 0           | 0          | 500           | 500          |
...
![](images/3c42e4b49a2dca70110c99ae59407044c32a4c50bd4c6336430a2593a9397035.jpg)
...
![](images/ba440f300ff4377662446f64425684ce45c3a7eda348864bc3574eb9ca8e332b.jpg)
...
![](images/4066178f3a8ec3e887fa4d033ba3ba444d0b086b67d8eaa562e52a5b5f84412a.jpg)
...
![](images/3354a1e92d47bba5f700571efbd732f53dee90d4fc4f1e84043248e0cc078e96.jpg)
...
| 20    | 0.05  | 0.19  | 0.01  | 0.99  |
| 25    | 0.03  | 0.14  | 0.01  | 0.99  |
</details>

![](images/5598163670a0ccc5a2339b58eca284e6a1ca9e3c864b957d35ee83f62a459d6a.jpg)
...
![](images/bb510d955dde91b8061e1a6e4b8add22a21aefd5dd11f2fb66a0702106050944.jpg)
...
![](images/4fc24748bfd1920c608c3e590840af78f75c3ff44d8684130105cb376b1ad4a6.jpg)
