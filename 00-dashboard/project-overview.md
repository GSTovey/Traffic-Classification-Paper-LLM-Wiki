...
Traffic_Papers 是一个基于 Obsidian 的**网络流量安全研究论文知识库**，当前收录 92 篇顶级会议/期刊论文（其中 40 篇已完成深度分析），服务于综述写作、项目申报、方法比较和实验复现。
...
| `09-claims/` | 观点与矛盾 | 2 个（42 Claims + 9 矛盾） | 论证、找 research gap |
...
- **WF 攻防演进链**：Deep Fingerprinting → RF → Swallow（攻击） ↔ Palette（防御） ↔ Robust Multi-tab WF ↔ Fine-grained WF
- **逃逸攻击线**：Black-Box Evasion ↔ Wedjat（因果分析） ↔ CertTA（认证鲁棒性）

---

## 6. 27 条核心 Claims（可直接引用）
