...
本页面用于维护个人研究方向地图，所有链接指向知识库中实际存在的页面。
...
- [[encrypted-traffic-analysis]] — 加密流量分析核心问题
...
- [[traffic-representation]] — 流量表征任务

### 2.2 表征学习与基础模型

- [[traffic-representation-learning]] — 流量表征学习核心范式
- [[traffic-foundation-model]] — 流量基础模型设计与训练
