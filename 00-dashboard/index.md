...
| 页面 | 说明 |
|---|---|
| [[reading-queue]] | 全部 50 篇论文的阅读状态与重要性标记 |
...
| 目录 | 用途 |
|---|---|
| `00-inbox/PDFs/` | 待处理和已处理的 50 篇 PDF 原文 |
| `01-mineru-output/` | MinerU API 返回的 50 份原始解析结果 |
| `02-parsed-markdown/` | 整理后的 50 份 MinerU Markdown 文件 |
...
| 目录 | 用途 | 当前数量 |
|---|---|---|
| `03-paper-notes/` | 单篇论文结构化笔记 | 50 篇 |
| `04-concepts/` | 研究概念页 | 9 个 |
| `05-methods/` | 方法页 | 8 个 |
| `06-tasks/` | 任务页 | 8 个 |
| `07-surveys/` | 综述页 | 5 个 |
| `08-comparisons/` | 对比表 | 2 个 |
...
- 50 篇 PDF 已导入 `00-inbox/PDFs/`。
- 50 篇 MinerU Markdown 已生成至 `01-mineru-output/`。
- 50 篇结构化论文笔记已创建于 `03-paper-notes/`。
- 9 个概念页已创建于 `04-concepts/`。
- 8 个方法页已创建于 `05-methods/`。
- 8 个任务页已创建于 `06-tasks/`。
- 5 个综述页已创建于 `07-surveys/`。
- 2 个对比表已创建于 `08-comparisons/`。
